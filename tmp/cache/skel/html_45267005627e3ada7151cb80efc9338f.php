...
'</a></li>
	...
	AND 1000*($timer = (time()+microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_breves @ ../plugins-dist/breves/prive/squelettes/inclure/plan-breves.html","profiler"._LOG_AVERTISSEMENT);
	return $t0;
}

//
// Fonction principale du squelette ../plugins-dist/breves/prive/squelettes/inclure/plan-breves.html
// Temps de compilation total: 6.089 ms
//
...
function html_45267005627e3ada7151cb80efc9338f($Cache, $Pile, $doublons=array(), $Numrows=array(), $SP=0) {
	...
	$connect = '';
	$page = (
vide($Pile['vars'][$_zzz=(string)'nomp'] = (	'sitrub' .
	@$Pile[0]['id_rubrique'])) .
