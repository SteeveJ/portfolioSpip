...
'<'.'?php echo recuperer_fond( ' . argumenter_squelette('prive/objets/contenu/auteur') . ', array(\'id\' => ' . argumenter_squelette($Pile[$SP]['id_auteur']) . ',
	...
	\'lang\' => ' . argumenter_squelette($GLOBALS["spip_lang"]) . '), array("compil"=>array(\'../prive/squelettes/contenu/auteur.html\',\'html_1513d70c8be80b6cfade95f9c76dc9d1\',\'\',12,$GLOBALS[\'spip_lang\'])), _request("connect"));
?'.'>
</div>
...
// Temps de compilation total: 23.183 ms
//
