 ...
 * Compile :   Thu, 04 Jun 2015 20:13:02 GMT
 * Boucles :   _restreint
 */ 

function BOUCLE_restreinthtml_1d5f0f981407237cdf15a9009d09b85f(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {

	static $command = array();
	static $connect;
	$command['connect'] = $connect = '';
	if (!isset($si_init)) { $command['si'] = array(); $si_init = true; }
	$command['si'][] = interdire_scripts((@$Pile[0]['statut'] == '0minirezo'));
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('../prive/objets/infos/inc-auteur-rubriques.html','html_1d5f0f981407237cdf15a9009d09b85f','_restreint',1,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
...
// Temps de compilation total: 8.720 ms
//

function html_1d5f0f981407237cdf15a9009d09b85f($Cache, $Pile, $doublons=array(), $Numrows=array(), $SP=0) {
	...
	$connect = '';
	$page = (
(($t1 = BOUCLE_restreinthtml_1d5f0f981407237cdf15a9009d09b85f($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		((	'
...
' .
	(($t2 = strval(interdire_scripts((((@$Pile[0]['statut'] == '0minirezo')) ?' ' :''))))!=='' ?
			($t2 . (	'
	' .
		(($t3 = strval(((@$Pile[0]['id_auteur'] == interdire_scripts(invalideur_session($Cache, table_valeur($GLOBALS["visiteur_session"], (string)'id_auteur', null)))) ? _T('public|spip|ecrire:info_admin_gere_toutes_rubriques_2'):_T('public|spip|ecrire:info_admin_gere_toutes_rubriques'))))!=='' ?
				('<p>' . $t3 . '</p>') :
				'') .
		'
')) :
...
'
	...
	return analyse_resultat_skel('html_1d5f0f981407237cdf15a9009d09b85f', $Cache, $page, '../prive/objets/infos/inc-auteur-rubriques.html');
}
?>