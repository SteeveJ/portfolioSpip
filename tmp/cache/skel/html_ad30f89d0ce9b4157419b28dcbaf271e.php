 ...
 * Compile :   Thu, 04 Jun 2015 23:08:08 GMT
...
quete_condition_postdates('articles.date',''), 
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('squelettes-dist/article.html','html_ad30f89d0ce9b4157419b28dcbaf271e','_articles_rubrique',69,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	lang_select($GLOBALS['spip_lang']);
	$SP++;
...
'<'.'?php echo recuperer_fond( ' . argumenter_squelette('inclure/forum') . ', array(\'id_article\' => ' . argumenter_squelette($Pile[$SP]['id_article']) . ',
	\'lang\' => ' . argumenter_squelette($GLOBALS["spip_lang"]) . '), array("compil"=>array(\'squelettes-dist/article.html\',\'html_ad30f89d0ce9b4157419b28dcbaf271e\',\'\',52,$GLOBALS[\'spip_lang\'])), _request("connect"));
?'.'>
			' .
(($t1 = strval(executer_balise_dynamique('FORMULAIRE_FORUM',
	...
	array('squelettes-dist/article.html','html_ad30f89d0ce9b4157419b28dcbaf271e','_principale',44,$GLOBALS['spip_lang'], 'articles',4))))!=='' ?
		((	'<h2>' .
...
'<'.'?php echo recuperer_fond( ' . argumenter_squelette('inclure/navsub') . ', array(\'id_rubrique\' => ' . argumenter_squelette($Pile[$SP]['id_rubrique']) . ',
	\'lang\' => ' . argumenter_squelette($GLOBALS["spip_lang"]) . '), array("compil"=>array(\'squelettes-dist/article.html\',\'html_ad30f89d0ce9b4157419b28dcbaf271e\',\'\',61,$GLOBALS[\'spip_lang\'])), _request("connect"));
?'.'>
			' .
executer_balise_dynamique('FORMULAIRE_RECHERCHE',
	array(),
	array('squelettes-dist/article.html','html_ad30f89d0ce9b4157419b28dcbaf271e','_principale',62,$GLOBALS['spip_lang'])) .
'
...
'
	...
	((($recurs=(isset($Pile[0]['recurs'])?$Pile[0]['recurs']:0))>=5)? '' :
	recuperer_fond('modeles/article_mots', array('lang' => $GLOBALS["spip_lang"] ,'id_article'=>$Pile[$SP]['id_article'],'id'=>$Pile[$SP]['id_article'],'recurs'=>(++$recurs)), array('compil'=>array('squelettes-dist/article.html','html_ad30f89d0ce9b4157419b28dcbaf271e','_principale',81,$GLOBALS['spip_lang']), 'trim'=>true), ''))
 .
'</div><!--.aside-->
	</div><!--.main-->
...
'<'.'?php echo recuperer_fond( ' . argumenter_squelette('inclure/footer') . ', array_merge('.var_export($Pile[0],1).',array(\'self\' => ' . argumenter_squelette(self()) . ',
	\'lang\' => ' . argumenter_squelette($GLOBALS["spip_lang"]) . ')), array("compil"=>array(\'squelettes-dist/article.html\',\'html_ad30f89d0ce9b4157419b28dcbaf271e\',\'\',86,$GLOBALS[\'spip_lang\'])), _request("connect"));
?'.'>
...
// Temps de compilation total: 36.944 ms
//
