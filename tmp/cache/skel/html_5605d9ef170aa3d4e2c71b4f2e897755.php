...
function BOUCLE_artshtml_5605d9ef170aa3d4e2c71b4f2e897755(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('../prive/objets/infos/auteur.html','html_5605d9ef170aa3d4e2c71b4f2e897755','_arts',22,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
...
quete_condition_statut('auteurs.statut','!5poubelle','!5poubelle',''), 
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('../prive/objets/infos/auteur.html','html_5605d9ef170aa3d4e2c71b4f2e897755','_publie',35,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
...
'<'.'?php echo recuperer_fond( ' . argumenter_squelette('prive/objets/infos/inc-auteur-rubriques') . ', array(\'id_auteur\' => ' . argumenter_squelette($Pile[$SP]['id_auteur']) . ',
	...
	\'lang\' => ' . argumenter_squelette($GLOBALS["spip_lang"]) . '), array("compil"=>array(\'../prive/objets/infos/auteur.html\',\'html_5605d9ef170aa3d4e2c71b4f2e897755\',\'\',10,$GLOBALS[\'spip_lang\'])), _request("connect"));
?'.'>' .
'
...
// Temps de compilation total: 91.745 ms
//
