...
'
		' .
(($t1 = strval(interdire_scripts(sinon(table_valeur(@$Pile[0], (string)'titre', null), interdire_scripts(((($a = generer_info_entite(@$Pile[0]['id_auteur'], 'auteur', 'nom')) OR (is_string($a) AND strlen($a))) ? $a : _T('public|spip|ecrire:info_sans_titre')))))))!=='' ?
