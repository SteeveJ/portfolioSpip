 ...
 * Compile :   Fri, 05 Jun 2015 22:29:04 GMT
...
'</h1>
			...
			' .
(($t1 = strval(interdire_scripts(filtrer('image_graver',filtrer('image_reduire',traiter_doublons_documents($doublons, propre($Pile[$SP]['texte'], $connect, $Pile[0])),'500','*')))))!=='' ?
...
// Temps de compilation total: 154.587 ms
//
