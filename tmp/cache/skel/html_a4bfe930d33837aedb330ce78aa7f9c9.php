...
'</a></li>
	...
	AND 1000*($timer = (time()+microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_articles @ ../prive/squelettes/inclure/plan-articles.html","profiler"._LOG_AVERTISSEMENT);
	return $t0;
}

//
// Fonction principale du squelette ../prive/squelettes/inclure/plan-articles.html
// Temps de compilation total: 5.445 ms
//
...
function html_a4bfe930d33837aedb330ce78aa7f9c9($Cache, $Pile, $doublons=array(), $Numrows=array(), $SP=0) {
	...
	$connect = '';
	$page = (
vide($Pile['vars'][$_zzz=(string)'nomp'] = (	'artrub' .
	@$Pile[0]['id_rubrique'])) .
