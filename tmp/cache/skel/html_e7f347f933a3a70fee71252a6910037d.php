...
'</a></li>
	...
	AND 1000*($timer = (time()+microtime())-$timer) > _BOUCLE_PROFILER)
		spip_log(intval(1000*$timer)."ms BOUCLE_sites @ ../plugins-dist/sites/prive/squelettes/inclure/plan-syndic.html","profiler"._LOG_AVERTISSEMENT);
	return $t0;
}

//
// Fonction principale du squelette ../plugins-dist/sites/prive/squelettes/inclure/plan-syndic.html
// Temps de compilation total: 4.670 ms
//
