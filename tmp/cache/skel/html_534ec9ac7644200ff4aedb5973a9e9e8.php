...
function BOUCLE_sthtml_534ec9ac7644200ff4aedb5973a9e9e8(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"DATA",
		$command,
		array('../prive/squelettes/contenu/visiteurs.html','html_534ec9ac7644200ff4aedb5973a9e9e8','_st',5,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
// Temps de compilation total: 13.951 ms
//

function html_534ec9ac7644200ff4aedb5973a9e9e8($Cache, $Pile, $doublons=array(), $Numrows=array(), $SP=0) {
...
'
' .
(($t1 = BOUCLE_sthtml_534ec9ac7644200ff4aedb5973a9e9e8($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		((	'
...
executer_balise_dynamique('FORMULAIRE_RECHERCHE_ECRIRE',
	array(self(),'ajax'),
	array('../prive/squelettes/contenu/visiteurs.html','html_534ec9ac7644200ff4aedb5973a9e9e8','',17,$GLOBALS['spip_lang'])) .
...
');
	...
	return analyse_resultat_skel('html_534ec9ac7644200ff4aedb5973a9e9e8', $Cache, $page, '../prive/squelettes/contenu/visiteurs.html');
}
?>