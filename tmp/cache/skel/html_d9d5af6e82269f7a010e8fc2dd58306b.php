...
function BOUCLE_comptemhtml_d9d5af6e82269f7a010e8fc2dd58306b(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
  ...
  array (
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('../plugins-dist/medias/prive/squelettes/inclure/mediatheque-navigation.html','html_d9d5af6e82269f7a010e8fc2dd58306b','_comptem',9,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
...
function BOUCLE_mediashtml_d9d5af6e82269f7a010e8fc2dd58306b(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"DATA",
		$command,
		array('../plugins-dist/medias/prive/squelettes/inclure/mediatheque-navigation.html','html_d9d5af6e82269f7a010e8fc2dd58306b','_medias',8,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
'
	' .
BOUCLE_comptemhtml_d9d5af6e82269f7a010e8fc2dd58306b($Cache, $Pile, $doublons, $Numrows, $SP)
. (	'
	' .
...
function BOUCLE_comptehtml_d9d5af6e82269f7a010e8fc2dd58306b(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
  ...
  array (
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('../plugins-dist/medias/prive/squelettes/inclure/mediatheque-navigation.html','html_d9d5af6e82269f7a010e8fc2dd58306b','_compte',50,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
...
function BOUCLE_typeshtml_d9d5af6e82269f7a010e8fc2dd58306b(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('../plugins-dist/medias/prive/squelettes/inclure/mediatheque-navigation.html','html_d9d5af6e82269f7a010e8fc2dd58306b','_types',47,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
'
	' .
BOUCLE_comptehtml_d9d5af6e82269f7a010e8fc2dd58306b($Cache, $Pile, $doublons, $Numrows, $SP)
. (	'
	' .
	(($Numrows['_compte']['total'])  ?
			(' ' . (($t3 = strval(lien_ou_expose(parametre_url(table_valeur($Pile["vars"], (string)'self', null),'extension',interdire_scripts($Pile[$SP]['extension'])),interdire_scripts(concat(typo(supprimer_numero($Pile[$SP]['titre']), "TYPO", $connect, $Pile[0]),' (',$Numrows['_compte']['total'],')')),interdire_scripts((entites_html(table_valeur(@$Pile[0], (string)'extension', null),true) == interdire_scripts($Pile[$SP]['extension']))),'ajax')))!=='' ?
				('<li>' . $t3 . '<span> | </span></li>') :
				'')) :
			'') .
	'
...
// Temps de compilation total: 72.528 ms
//

function html_d9d5af6e82269f7a010e8fc2dd58306b($Cache, $Pile, $doublons=array(), $Numrows=array(), $SP=0) {
...
'
' .
BOUCLE_mediashtml_d9d5af6e82269f7a010e8fc2dd58306b($Cache, $Pile, $doublons, $Numrows, $SP) .
'
</ul>
...
' .
(($t1 = BOUCLE_typeshtml_d9d5af6e82269f7a010e8fc2dd58306b($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		('
<ul class=\'choix-type\'>
	' . $t1 . '
</ul>
...
executer_balise_dynamique('FORMULAIRE_RECHERCHE_ECRIRE',
	...
	array('../plugins-dist/medias/prive/squelettes/inclure/mediatheque-navigation.html','html_d9d5af6e82269f7a010e8fc2dd58306b','',58,$GLOBALS['spip_lang'])) .

'<'.'?php echo recuperer_fond( ' . argumenter_squelette(interdire_scripts(entites_html(sinon(table_valeur(@$Pile[0], (string)'galerie', null), 'prive/squelettes/inclure/mediatheque-galerie'),true))) . ', array_merge('.var_export($Pile[0],1).',array(\'lang\' => ' . argumenter_squelette($GLOBALS["spip_lang"]) . ')), array("compil"=>array(\'../plugins-dist/medias/prive/squelettes/inclure/mediatheque-navigation.html\',\'html_d9d5af6e82269f7a010e8fc2dd58306b\',\'\',60,$GLOBALS[\'spip_lang\']),\'ajax\' => ($v=( ' . argumenter_squelette('documents') . '))?$v:true), _request("connect"));
?'.'>' .
'
...
')) :
	...
	'
' .
	(($t2 = strval(recuperer_fond( 'prive/squelettes/inclure/ajouter-documents' , array_merge($Pile[0],array()), array('ajax' => ($v=( @$Pile[0]['ajax'] ))?$v:true,'compil'=>array('../plugins-dist/medias/prive/squelettes/inclure/mediatheque-navigation.html','html_d9d5af6e82269f7a010e8fc2dd58306b','',57,$GLOBALS['spip_lang'])), '')))!=='' ?
			('
' . $t2 . '
') :
			'') .
...
');
	...
	return analyse_resultat_skel('html_d9d5af6e82269f7a010e8fc2dd58306b', $Cache, $page, '../plugins-dist/medias/prive/squelettes/inclure/mediatheque-navigation.html');
}
?>